...
const Login = () => {
  return (
    <div className='grid grid-col-1 sm:grid-cols-3 md:h-screen h-2'>
      ...
      <div className='ml-4 w-full md:ml-0 bg-[ #FFFFFF] mt-8 pr-4'>
        <div className=''>
          <h1 className='text-4xl font-bold mt-4 '>Login</h1>
          <p className='text-gray-500 mt-4'>Please input your information in <br />the fields below. </p>
        </div>
        <div>
          <form>
            <div className='py-6'>
            ...
            <div className='mt-6'>
              <p className=''><span className='hover:underline'>Forgotten your password?</span><br className='md:hidden'/>
              <input type='checkbox' className='md:ml-20' />   Remember me</p>
            </div>
            <div className='bg-[#13BFB3] hover:bg-[#0ca69b] shadow-lg md:w-96 font-medium mt-4 mr-2 h-11 rounded-lg text-sm py-3'>
              <a href="lo" className='flex justify-center rounded-lg text-sm text-white font-semibold '>Login</a>
            </div>
            <p className='mt-4'>  Already have an account?<a href='s' className='text-[#13BFB3] hover:underline'>  Login</a></p>
          </form>
        </div>
        <hr className='md:mt-20 w-full mt-4 mb-4 '></hr>
