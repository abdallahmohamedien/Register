  ...
  return (
    <div className='grid grid-col-1 sm:grid-cols-3 md:h-screen h-2'>
      ...
      <div className='ml-4 md:w-max md:ml-0 bg-[ #FFFFFF] mt-8 pr-4'>
        <div className=''>
          <h1 className='text-4xl font-bold mt-4 '>Reset your password</h1>
          <p className='text-gray-500 mt-4'>Enter the email address, and we’ll send you a reset link.</p>
        </div>
        <div>
          <form>
            <div className='py-6'>
            ...
            <div className='bg-[#13BFB3] hover:bg-[#0ca69b] shadow-lg md:w-96 font-medium mt-4 mr-2 h-11 rounded-lg text-sm py-3'>
              <a href="lo" className='flex justify-center rounded-lg text-sm text-white font-semibold '>Send rest link</a>
            </div>
            <p className='mt-4'>  Don't have an account yet? <a href='s' className='text-[#13BFB3] hover:underline'>  Register now</a></p>
          </form>
        </div>
        <hr className='flex mt-4 mb-4 md:mt-64'></hr>
